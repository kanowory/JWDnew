...
public class Alice {
    public static void main(String[] args) {
       ...
       //System.out.println(startLetterStats);
        System.out.println("Litera na którą zaczyna sie najwięcej wyrazów to: \"" + startLetterEntry.getKey() + "\", jest ich " + startLetterEntry.getValue() + ".");
    }
    ...
    public static Set divideIntoWordsAndClean(List<String> allLines){
        Set words = new TreeSet();//domyślne sortowanie
        for (String line: allLines) {
